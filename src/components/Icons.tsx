...
export function DumbbellIcon({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h1m16 0h1M5.5 8.5v7M18.5 8.5v7M7 10v4a1 1 0 001 1h8a1 1 0 001-1v-4a1 1 0 00-1-1H8a1 1 0 00-1 1z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 10v4M20 10v4" />
    </svg>
  );
}
